        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hide-menu">Categories Detail<span class="fa arrow"></span>
                        <span class="label label-rouded label-purple pull-right">2</span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="{{URL::to('/add-categorydetail')}}"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i><span class="hide-menu">Thêm Categories</span></a></li>
                            <li><a href="{{URL::to('/all-categorydetail')}}"><i class="fa-fw">S</i><span class="hide-menu"> Hiển Thị Categories</span></a></li>
                        </ul>
                    </li>
